...
const Login = () => {
  ...
  return (
    <div className="min-h  flex mt-10  justify-center bg-gradient-to-br from-teal-50 to-indigo-100 p-4">
      <div className="w-full mb-5 h-100 max-w-md mt-10 bg-white/80 backdrop-blur-lg shadow-xl rounded-lg">
