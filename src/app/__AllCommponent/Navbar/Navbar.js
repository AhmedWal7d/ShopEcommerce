              ...
              <ul className="flex items-center gap-6 text-sm ">
                <li>
                  <Link
                    className={
                      pathname == "/"
                        ? "bg-teal-700 py-2.5 px-1.5 rounded-lg text-white font-bold"
          ...
          <div className="pt-2 pb-4 space-y-1">
            ...
            {isLoading ? (
              ...
              <div className=" sm:flex items-center gap-4">
                <div className="flex">
                  <Link href="/heart" className="text-white relative mt-5 mx-4">
                    <FaRegHeart size={28} />
                ...
                <select
                  onChange={handleSelectChange}
                  className="bg-teal-700 text-white px-4 py-2 rounded-md mt-5 mb-5"
                >
                  <option value="">{username}</option>
                  <option value="logout">Logout</option>
                </select>
